...
def process_dwpose(input_video_path, output_pose_path, output_mask_path, det_model_path=None, pose_model_path=None):

    # If model paths are not provided, fall back to local ./models (upstream layout)
